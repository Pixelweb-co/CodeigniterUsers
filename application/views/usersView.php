...
alert(23)
    $.ajax({
      url:"<?php echo base_url(); ?>userController/load_data",
      dataType:"JSON",
      success:function(data){
        ...
        html += '<td id="age" contenteditable placeholder="Enter age"></td>';
  ...
  $(document).on('click', '#btn_add', function(){
    ...
    $.ajax({
      ...
      method:"POST",
      data:{first_name:first_name, last_name:last_name, gender:gender,age:age},
      success:function(data){
        load_data();
      }
    })
  ...
  $(document).on('blur', '.table_data', function(){
    ...
    var value = $(this).text();
    $.ajax({
      url:"<?php echo base_url(); ?>userController/update",
      method:"POST",
  ...
  $(document).on('click', '.btn_delete', function(){
    ...
    {
      $.ajax({
        url:"<?php echo base_url(); ?>userController/delete",
        method:"POST",
        data:{id:id},
        success:function(data){
          load_data();
